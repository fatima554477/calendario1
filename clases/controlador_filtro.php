...
<?php } ?>
<?php 
if($database->plantilla_filtro($nombreTabla,"FALTA_POR_COBRAR",$altaeventos,$DEPARTAMENTO)=="si"){ ?><th style="background:#CCFF00;text-align:center">FALTA POR COBRAR</th>
<?php } ?>
<?php 
if($database->plantilla_filtro($nombreTabla,"FALTA_POR_FACTURAR",$altaeventos,$DEPARTAMENTO)=="si"){ ?><th style="background:#CCFF00;text-align:center">FALTA POR FACTURAR</th>
<?php } ?>
...
<?php  
if($database->plantilla_filtro($nombreTabla,"MONEDAS",$altaeventos,$DEPARTAMENTO)=="si"){ ?><td style="background:#c9e8e8;text-align:center"><input type="text" class="form-control" id="MONEDAS" value="<?php 
echo $MONEDAS; ?>"></td>
<?php } ?>
<?php  
...
<?php } ?>
		...
		<?php 	if ($numrows<0){ ?>
					...
					<div id="scroll-bottom-container" style="overflow-x: auto;">
  <table id="mi-tabla" style="width: max-content; border-collapse: collapse;">
		<?php }else{ ?>		
        <tbody>
		<?php
		$finales=0;
...
$colspan += 1;
?><td style="text-align:center"><?php echo $row['FECHA_ALTA_EVENTO'];?></td>
<?php } ?>
...
<?php } ?>
<?php  if($database->plantilla_filtro($nombreTabla,"NOMBRE_CORTO_EVENTO",$altaeventos,$DEPARTAMENTO)=="si"){ $colspan += 1;?><td style="text-align:center"><?php echo $row['NOMBRE_CORTO_EVENTO'];?></td>
<?php } ?>
...
$colspan += 1;	
?><td style="text-align:center"><?php echo $row['CIERRE_TOTAL'];?></td>
<?php } ?>
...
<?php } ?>
<?php  if($database->plantilla_filtro($nombreTabla,"NUMERO_DE_PERSONAS",$altaeventos,$DEPARTAMENTO)=="si"){ ?><td style="text-align:center"><?php echo $row['NUMERO_DE_PERSONAS'];?></td>
<?php } ?>
<?php  if($database->plantilla_filtro($nombreTabla,"FECHA_INICIO_EVENTO",$altaeventos,$DEPARTAMENTO)=="si"){ ?><td style="text-align:center"><?php echo $row['FECHA_INICIO_EVENTO'];?></td>
<?php } ?>
...
<?php } ?>
<?php  if($database->plantilla_filtro($nombreTabla,"FECHA_FINAL_EVENTO",$altaeventos,$DEPARTAMENTO)=="si"){ ?><td style="text-align:center"><?php echo $row['FECHA_FINAL_EVENTO'];?></td>
<?php } ?>
...
<?php } ?>
<?php  if($database->plantilla_filtro($nombreTabla,"FECHA_LLEGADA_STAFF",$altaeventos,$DEPARTAMENTO)=="si"){ ?><td style="text-align:center"><?php echo $row['FECHA_LLEGADA_STAFF'];?></td>
<?php } ?>
...
<?php } ?>
<?php  if($database->plantilla_filtro($nombreTabla,"FECHA_REGRESO_STAFF",$altaeventos,$DEPARTAMENTO)=="si"){ ?><td style="text-align:center"><?php echo $row['FECHA_REGRESO_STAFF'];?></td>
<?php } ?>
...
<?php } ?>   
 <?php  if($database->plantilla_filtro($nombreTabla,"FECHA_INICIO_MONTAJE",$altaeventos,$DEPARTAMENTO)=="si"){ ?><td style="text-align:center"><?php echo $row['FECHA_INICIO_MONTAJE'];?></td>
<?php } ?>   
...
<?php } ?>   
  <?php  if($database->plantilla_filtro($nombreTabla,"FECHA_DESMONTAJE",$altaeventos,$DEPARTAMENTO)=="si"){ ?><td style="text-align:center"><?php echo $row['FECHA_DESMONTAJE'];?></td>
<?php } ?>   
...
echo $database->FALATA_POR_COBRAR($row['id04altaeventos'],$montoTotalEvento);
 echo $row['FALTA_POR_COBRAR'];
 $totales = 'si';
 $faltaporcobrartotal+= $row['FALTA_POR_COBRAR']; 
...
<?php  if($database->plantilla_filtro($nombreTabla,"FALTA_POR_FACTURAR",$altaeventos,$DEPARTAMENTO)=="si"){ ?><td style="text-align:center">$<?php echo $row['FALTA_POR_FACTURAR'];

echo $database->FALATA_POR_FACTURAR($row['id04altaeventos'],$montoTotalEvento);
 $totales = 'si';
 $faltaporfacturartotal+= $row['FALTA_POR_FACTURAR']; 
...
<td style="text-align:center">$<?php echo $row['PERDIDA_FISCAL'];

echo $database->PERDIDA_DE_COSTO_FISCAL($row['NUMERO_EVENTO']);
 $totales = 'si';
 $perdidafiscaltotal+= $row['PERDIDA_FISCAL']; 
...
<td style="text-align:center"><strong style="font-size:16px">$<?php echo number_format($MONTOC_TOTAL_EVENTO12,2,'.',','); ?></strong></td>
<?php } ?>
<?php  if($database->plantilla_filtro($nombreTabla,"CANTIDAD_PORCENTAJEV",$altaeventos,$DEPARTAMENTO)=="si"){  ?>
<td style="text-align:center"><strong style="font-size:16px">$<?php echo number_format($CANTIDAD_PORCENTAJEV12,2,'.',','); ?></strong></td>
<?php } ?>
<?php if($database->plantilla_filtro($nombreTabla,"MONTO_TOTAL_AVION",$altaeventos,$DEPARTAMENTO)=="si"){ ?>
<td style="text-align:center"><strong style="font-size:16px">$<?php  echo number_format($MONTO_TOTAL_AVION12,2,'.',','); ?></strong></td>
<?php } ?>
<?php if($database->plantilla_filtro($nombreTabla,"TOTAL_AVION_SINIVA",$altaeventos,$DEPARTAMENTO)=="si"){ ?>
<td style="text-align:center"><strong style="font-size:16px">$<?php  echo number_format($TOTAL_AVION_SINIVA12,2,'.',','); ?></strong></td>
<?php } ?>
<td></td>
<?php if($database->plantilla_filtro($nombreTabla,"FEE_COBRADO",$altaeventos,$DEPARTAMENTO)=="si"){ ?>
<td style="text-align:center"><strong style="font-size:16px">$<?php  echo number_format($FEE_COBRADO12,2,'.',','); ?></strong></td>
<?php } ?>

<?php if($database->plantilla_filtro($nombreTabla,"MONTO_TOTAL_DEL_EVENTO",$altaeventos,$DEPARTAMENTO)=="si"){ ?>
<td style="text-align:center"><strong style="font-size:16px">$<?php echo number_format($MONTO_TOTAL_DEL_EVENTO12,2,'.',','); ?></strong></td>
<?php } ?>



<?php if($totales == 'si'){ ?>
<td style="text-align:right; padding-right:45px;" colspan="<?php echo $colspan +22 ; ?>" ><strong style="font-size:16px">TOTALES</strong></td>

<?php  if($database->plantilla_filtro($nombreTabla,"FALTA_POR_COBRAR",$altaeventos,$DEPARTAMENTO)=="si"){  ?>
<td style="text-align:center"><strong style="font-size:16px">$<?php echo number_format($faltaporcobrartotal,2,'.',','); ?></strong></td>
<?php } ?>
<?php  if($database->plantilla_filtro($nombreTabla,"FALTA_POR_FACTURAR",$altaeventos,$DEPARTAMENTO)=="si"){  ?>
<td style="text-align:center"><strong style="font-size:16px">$<?php echo number_format($faltaporfacturartotal,2,'.',','); ?></strong></td>
<?php } ?>
<?php if($database->plantilla_filtro($nombreTabla,"PERDIDA_FISCAL",$altaeventos,$DEPARTAMENTO)=="si"){ ?>
<td style="text-align:center"><strong style="font-size:16px">$<?php  echo number_format($perdidafiscaltotal,2,'.',','); ?></strong></td>
<?php } ?>
<?php } ?>			
       <?php } ?>	
		</tbody>
